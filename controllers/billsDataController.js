...
//     // =========================
//     // 2️⃣ Query quotataion_adv ทีเดียว
//     // =========================
...
//       await connection.rollback();
//       return res.status(400).json({
//         message: "มี packageId บางรายการไม่พบใน quotataion_adv",
//       });
//     }
...
//     // =========================
//     // 3.5️⃣ หา warehouse จาก text address
//     // =========================
...
//           head.province ?? null,
//           head.zipCode ?? null,
//           warehouse.tambon_id ?? null, // sub_district_id
//           pkg.package_price ?? null, // ✅ PRICE จาก quotataion_adv
//           warehouse.warehouse_id ?? null, // warehouse_id
//           warehouse.warehouse_name ?? null, // warehouse_name
//           null, // user_id
//           "API",
//           1, // status_id
//           "รับเข้าระบบ", // status_name
//           pkg.group_id ?? null, // ✅ group_id
//           pkg.group_name ?? null, // ✅ group_name
...
//           d.packageId ?? null,
//           pkg.package_name ?? null, // ✅ package_name
